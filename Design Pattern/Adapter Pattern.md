...
>
> - 사용 방법 : 객체 합성(Composition) 또는 상속 (아래 예제는 합성 방식의 객체 어댑터)
...
```
아까 확인한 클래스 다이어그램에서 Target은 오리(Duck) 인터페이스에 해당하며, Adaptee는 칠면조(Turkey), Adapter는 칠면조 어댑터(TurkeyAdapter)라고 생각하면 된다.
